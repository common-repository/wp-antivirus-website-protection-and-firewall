...
{
	public static  $antivirus_version = '8.0.4';
    ...
    public static function CheckGEOProtectionInstallation()
    {
		...
		$path = str_replace('wp-antivirus-website-protection-and-website-firewall', 'wp-geo-website-protection', $path);
	...
	public static function scan($check_session = true, $show_results = true)
	{
		...
		if (file_exists(dirname(__FILE__).DIRSEP.'scanner.class.php'))
		{
    		...
    		if (!defined('ABSPATH') || strlen(ABSPATH) < 8) 
    		{
    			...
    			$scan_path = str_replace(DIRSEP.'wp-content'.DIRSEP.'plugins'.DIRSEP.'wp-antivirus-website-protection-and-website-firewall', DIRSEP, $scan_path);
        		//echo TEST;
    		}
